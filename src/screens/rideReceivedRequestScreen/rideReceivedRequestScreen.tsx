...
import { rideReqType, rideType, ridesStatusType, userType } from '../../constants/types/sharedTypes';
import { DateTimePickerAndroid, DateTimePickerEvent } from '@react-native-community/datetimepicker';
import RideRecvCard from '../../components/general/rideCard/rideReceivedReqCard';
import colors from '../../theme/colors';



export default function RideReqRecv() {
    ...
    const [data, setData] = useState<rideReqType[] | null>(null);
